    ...
    `;
      ...
      `;
                ...
                _genEventBinding(eb) {
                    ...
                    collection_1.ListWrapper.forEachWithIndex(eb.records, (r, i) => {
                        let code;
    ...
    if (eventName === "${eb.eventName}" && elIndex === ${eb.elIndex}) {
      ...
      `;
                ...
                _genConditionalSkip(r, condition) {
                    let maybeNegate = r.mode === proto_record_1.RecordType.SkipRecordsIf ? '!' : '';
                ...
                _genEndOfSkipBlock(protoIndex) {
                    if (!collection_1.ListWrapper.isEmpty(this._endOfBlockIdxs)) {
                        let endOfBlock = collection_1.ListWrapper.last(this._endOfBlockIdxs);
