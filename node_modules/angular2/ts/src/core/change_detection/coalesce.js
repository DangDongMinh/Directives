System.register(['angular2/src/facade/lang', 'angular2/src/facade/collection', './proto_record'], function(exports_1, context_1) {
    ...
    function coalesce(srcRecords) {
        let dstRecords = [];
        let excludedIdxs = [];
        let indexMap = new collection_1.Map();
        let skipDepth = 0;
        let skipSources = collection_1.ListWrapper.createFixedSize(srcRecords.length);
    ...
    function _findFirstMatch(record, dstRecords, excludedIdxs) {
        ...
        rr => excludedIdxs.indexOf(rr.selfIndex) == -1 && rr.mode !== proto_record_1.RecordType.DirectiveLifecycle &&
