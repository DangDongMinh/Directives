    ...
    return {
        ...
        execute: function() {
            ...
            class AbstractChangeDetector {
                ...
                removeContentChild(cd) { collection_1.ListWrapper.remove(this.contentChildren, cd); }
                addViewChild(cd) {
                    this.viewChildren.push(cd);
                    cd.parent = this;
                }
                removeViewChild(cd) { collection_1.ListWrapper.remove(this.viewChildren, cd); }
                ...
                hydrated() { return lang_1.isPresent(this.context); }
                destroyRecursive() {
                ...
                throwDehydratedError(detail) { throw new exceptions_1.DehydratedException(detail); }
                _currentBinding() {
