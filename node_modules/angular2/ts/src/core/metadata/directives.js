System.register(['angular2/src/facade/lang', 'angular2/src/core/di/metadata', 'angular2/src/core/change_detection'], function(exports_1, context_1) {
    ...
    return {
        ...
        execute: function() {
             ...
             */
            let DirectiveMetadata = class DirectiveMetadata extends metadata_1.InjectableMetadata {
            ...
            let ComponentMetadata = class ComponentMetadata extends DirectiveMetadata {
                constructor({ selector, inputs, outputs, properties, events, host, exportAs, moduleId, bindings, providers, viewBindings, viewProviders, changeDetection = change_detection_1.ChangeDetectionStrategy.Default, queries, templateUrl, template, styleUrls, styles, directives, pipes, encapsulation } = {}) {
                    super({
                        selector: selector,
                        inputs: inputs,
                        outputs: outputs,
             ...
             */
            let PipeMetadata = class PipeMetadata extends metadata_1.InjectableMetadata {
