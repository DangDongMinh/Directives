...
System.register(['./metadata/di', './metadata/directives', './metadata/view', './util/decorators'], function(exports_1, context_1) {
    ...
    return {
        ...
        execute: function() {
             ...
             */
            exports_1("Component", Component = decorators_1.makeDecorator(directives_1.ComponentMetadata, (fn) => fn.View = View));
             ...
             * ```
             */
            exports_1("View", View = decorators_1.makeDecorator(view_1.ViewMetadata, (fn) => fn.View = View));
            /**
