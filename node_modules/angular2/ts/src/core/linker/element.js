System.register(['angular2/src/facade/lang', 'angular2/src/facade/exceptions', 'angular2/src/facade/collection', 'angular2/src/core/di', 'angular2/src/core/di/provider', 'angular2/src/core/di/injector', '../metadata/di', './view_type', './element_ref', './view_container_ref', 'angular2/src/core/render/api', './template_ref', '../metadata/directives', 'angular2/src/core/change_detection/change_detection', './query_list', 'angular2/src/core/reflection/reflection', 'angular2/src/core/pipes/pipe_provider'], function(exports_1, context_1) {
    ...
    return {
        ...
        execute: function() {
            ...
            class DirectiveDependency extends di_1.Dependency {
                ...
                static _attributeName(properties) {
                    var p = properties.find(p => p instanceof di_2.AttributeMetadata);
                    return lang_1.isPresent(p) ? p.attributeName : null;
                }
                /** @internal */
                static _query(properties) {
                    return properties.find(p => p instanceof di_2.QueryMetadata);
                }
            }
            exports_1("DirectiveDependency", DirectiveDependency);
            class DirectiveProvider extends provider_2.ResolvedProvider_ {
                constructor(key, factory, deps, isComponent, providers, viewProviders, queries) {
                    super(key, [new provider_2.ResolvedFactory(factory, deps)], false);
                ...
                static createFromType(type, meta) {
                    ...
                    if (lang_1.isPresent(meta.queries)) {
                        collection_1.StringMapWrapper.forEach(meta.queries, (meta, fieldName) => {
            ...
            class AppElement {
                constructor(proto, parentView, parent, nativeElement, embeddedViewFactory) {
                    ...
                    if (lang_1.isPresent(this.proto.protoInjector)) {
                        ...
                        this._injector = new di_1.Injector(this.proto.protoInjector, parentInjector, isBoundary, this, () => this._debugContext());
                        ...
                        case view_type_1.ViewType.HOST:
                            if (lang_1.isPresent(containerAppElement)) {
                                ...
                                if (lang_1.isPresent(imperativelyCreatedProviders)) {
                                    var imperativeProvidersWithVisibility = imperativelyCreatedProviders.map(p => new injector_1.ProviderWithVisibility(p, injector_1.Visibility.Public));
                ...
                hasDirective(type) { return lang_1.isPresent(this._injector.getOptional(type)); }
                getComponent() { return lang_1.isPresent(this._strategy) ? this._strategy.getComponent() : null; }
                getInjector() { return this._injector; }
                getElementRef() { return this.ref; }
                getViewContainerRef() { return new view_container_ref_2.ViewContainerRef_(this); }
                getTemplateRef() {
            ...
            class ProtoQueryRef {
                ...
                get usesPropertySyntax() { return lang_1.isPresent(this.setter); }
            }
            ...
            class _ComponentViewChangeDetectorRef extends change_detection_1.ChangeDetectorRef {
