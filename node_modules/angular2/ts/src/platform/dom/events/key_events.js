System.register(['angular2/src/platform/dom/dom_adapter', 'angular2/src/facade/lang', 'angular2/src/facade/collection', './event_manager', 'angular2/src/core/di'], function(exports_1, context_1) {
    ...
    return {
        ...
        execute: function() {
            ...
            let KeyEventsPlugin = KeyEventsPlugin_1 = class KeyEventsPlugin extends event_manager_1.EventManagerPlugin {
                constructor() {
                    super();
                }
                supports(eventName) {
                    return lang_1.isPresent(KeyEventsPlugin_1.parseEventName(eventName));
                }
                addEventListener(element, eventName, handler) {
                    var parsedEvent = KeyEventsPlugin_1.parseEventName(eventName);
                    var outsideHandler = KeyEventsPlugin_1.eventCallback(element, collection_1.StringMapWrapper.get(parsedEvent, 'fullKey'), handler, this.manager.getZone());
                ...
                static eventCallback(element, fullKey, handler, zone) {
                    return (event) => {
                        if (lang_1.StringWrapper.equals(KeyEventsPlugin_1.getEventFullKey(event), fullKey)) {
