System.register(['angular2/src/platform/dom/dom_adapter', 'angular2/core', './event_manager'], function(exports_1, context_1) {
    ...
    return {
        ...
        execute: function() {
            let DomEventsPlugin = class DomEventsPlugin extends event_manager_1.EventManagerPlugin {
                ...
                addEventListener(element, eventName, handler) {
                    ...
                    return this.manager.getZone().runOutsideAngular(() => dom_adapter_1.DOM.onAndCancel(element, eventName, outsideHandler));
                }
