            ...
            class UpgradeAdapter {
                ...
                bootstrap(element, modules, config) {
                    ...
                    var applicationRef = platformRef.application([
                        ...
                        core_1.provide(constants_1.NG1_INJECTOR, { useFactory: () => ng1Injector }),
                        core_1.provide(constants_1.NG1_COMPILE, { useFactory: () => ng1Injector.get(constants_1.NG1_COMPILE) }),
                        this.providers
                    ]);
                    ...
                    ng1Module.value(constants_1.NG2_INJECTOR, injector)
                        ...
                        '$rootScope',
                            ...
                            async_1.ObservableWrapper.subscribe(ngZone.onTurnDone, (_) => ngZone.runOutsideAngular(() => rootScope.$apply()));
                            ng1compilePromise =
                                upgrade_ng1_adapter_1.UpgradeNg1ComponentAdapterBuilder.resolve(this.downgradedComponents, injector);
                        }
                    ]);
