            ...
            let DatePipe = DatePipe_1 = class DatePipe {
                transform(value, args) {
                    ...
                    if (!this.supports(value)) {
                        throw new invalid_pipe_argument_exception_1.InvalidPipeArgumentException(DatePipe_1, value);
                    }
                    var pattern = lang_1.isPresent(args) && args.length > 0 ? args[0] : 'mediumDate';
                    if (lang_1.isNumber(value)) {
                        value = lang_1.DateWrapper.fromMillis(value);
                    }
                    if (collection_1.StringMapWrapper.contains(DatePipe_1._ALIASES, pattern)) {
                        pattern = collection_1.StringMapWrapper.get(DatePipe_1._ALIASES, pattern);
                    }
