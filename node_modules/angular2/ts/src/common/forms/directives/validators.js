System.register(['angular2/core', 'angular2/src/facade/lang', '../validators'], function(exports_1, context_1) {
    ...
    return {
        ...
        execute: function() {
             ...
             */
            MIN_LENGTH_VALIDATOR = lang_1.CONST_EXPR(new core_1.Provider(validators_1.NG_VALIDATORS, { useExisting: core_1.forwardRef(() => MinLengthValidator), multi: true }));
            /**
             ...
             */
            MAX_LENGTH_VALIDATOR = lang_1.CONST_EXPR(new core_1.Provider(validators_1.NG_VALIDATORS, { useExisting: core_1.forwardRef(() => MaxLengthValidator), multi: true }));
            /**
