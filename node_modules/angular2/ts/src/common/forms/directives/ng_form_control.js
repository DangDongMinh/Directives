System.register(['angular2/src/facade/lang', 'angular2/src/facade/collection', 'angular2/src/facade/async', 'angular2/core', './ng_control', '../validators', './control_value_accessor', './shared'], function(exports_1, context_1) {
    ...
    return {
        ...
        execute: function() {
            formControlBinding = lang_1.CONST_EXPR(new core_1.Provider(ng_control_1.NgControl, { useExisting: core_1.forwardRef(() => NgFormControl) }));
            /**
             ...
             *  ```
             */
            let NgFormControl = class NgFormControl extends ng_control_1.NgControl {
