System.register(['angular2/src/facade/collection', 'angular2/src/facade/async', 'angular2/src/facade/lang', 'angular2/src/facade/exceptions', 'angular2/src/core/reflection/reflection', 'angular2/core', './route_config_impl', './route_recognizer', './component_recognizer', './instruction', './route_config_nomalizer', './url_parser'], function(exports_1, context_1) {
    ...
    function mostSpecific(instructions) {
        instructions = instructions.filter((instruction) => lang_1.isPresent(instruction));
            ...
            let RouteRegistry = class RouteRegistry {
                ...
                _auxRoutesToUnresolved(auxRoutes, parentInstructions) {
                    ...
                    auxRoutes.forEach((auxUrl) => {
                        unresolvedAuxInstructions[auxUrl.path] = new instruction_1.UnresolvedInstruction(() => { return this._recognize(auxUrl, parentInstructions, true); });
                    });
                ...
                generate(linkParams, ancestorInstructions, _aux = false) {
                    ...
                    if (collection_1.ListWrapper.first(params) == '') {
                        ...
                        if (collection_1.ListWrapper.first(params) == '.') {
                            ...
                            let routeName = collection_1.ListWrapper.first(params);
                            ...
                            if (parentRouteExists && childRouteExists) {
                                let msg = `Link "${collection_1.ListWrapper.toJSON(linkParams)}" is ambiguous, use "./" or "../" to disambiguate.`;
                ...
                _generate(linkParams, ancestorInstructions, prevInstruction, _aux = false, _originalLink) {
                    ...
                    let auxInstructions = {};
                    let parentInstruction = collection_1.ListWrapper.last(ancestorInstructions);
                    ...
                    if (linkParamIndex < linkParams.length && lang_1.isString(linkParams[linkParamIndex])) {
                        ...
                        if (lang_1.isBlank(routeRecognizer.handler.componentType)) {
                            ...
                            return new instruction_1.UnresolvedInstruction(() => {
