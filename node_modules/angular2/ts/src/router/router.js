    ...
    return {
        ...
        execute: function() {
            ...
            class Router {
                ...
                _emitNavigationFinish(url) { async_1.ObservableWrapper.callEmit(this._subject, url); }
            ...
            let RootRouter = class RootRouter extends Router {
                constructor(registry, location, primaryComponent) {
                    ...
                    this._locationSub = this._location.subscribe((change) => {
                        ...
                        this.recognize(change['url'])
                            .then((instruction) => {
                            this.navigateByInstruction(instruction, lang_1.isPresent(change['pop']))
                                .then((_) => {
